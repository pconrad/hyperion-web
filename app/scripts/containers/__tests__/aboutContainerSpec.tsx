...
describe('<AboutContainer />', () => {
    ...
    it('should dispatch action to retrieve data', () => {
        ...
        // Act
        const root = ReactTestUtils.renderIntoDocument(<AboutContainer loading={ false } retrieveData={ mock } />);
    ...
    it('should show loading indicator while loading', () => {
        ...
        // Act
        const root = ReactTestUtils.renderIntoDocument(<MuiThemeProvider><AboutContainer loading={ true } retrieveData={ mock } /></MuiThemeProvider>);
    ...
    it('should show error when one occurs', () => {
        ...
        // Act
        const root = ReactTestUtils.renderIntoDocument(<MuiThemeProvider><AboutContainer error={ error } loading={ false } retrieveData={ mock } /></MuiThemeProvider>);
    ...
    it('should retry when tapping the snackbar', () => {
        ...
        const error = new Error('Ahw, an error');
        const mock = jest.fn();
        const root = ReactTestUtils.renderIntoDocument(<MuiThemeProvider><AboutContainer error={ error } loading={ true } retrieveData={ mock } /></MuiThemeProvider>);
        const snackbar: React.Component<any, any> = ReactTestUtils.findRenderedComponentWithType(root as React.Component<any, any>, Snackbar);
